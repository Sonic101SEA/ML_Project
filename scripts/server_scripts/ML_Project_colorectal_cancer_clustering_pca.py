...
reduced = pca.transform(final_clustering_standard)
...
# plt.legend()
# plt.show()
# plt.savefig('silhouette_score_elbow_with_pca.pdf')
...
# for i in u_labels:
#     plt.scatter(reduced[y_kmeans == i , 0] , reduced[y_kmeans == i , 1] , label = i)
...
plt.legend()
plt.show()
plt.savefig('clustering_crc_with_pca.pdf')
